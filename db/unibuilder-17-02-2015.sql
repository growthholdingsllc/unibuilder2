...
--
-- Host: localhost
-- Generation Time: Feb 17, 2015 at 03:30 PM
...
--
-- Table structure for table `ub_message`
--

CREATE TABLE IF NOT EXISTS `ub_message` (
  `message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `job_id` bigint(20) unsigned NOT NULL,
  `subject` varchar(250) DEFAULT NULL COMMENT 'Message subject',
  `body` text COMMENT 'Message body',
  `sent_by` bigint(20) unsigned zerofill NOT NULL COMMENT 'Auther of the message. Reference to ub_user table user_id',
  `parent_message_id` bigint(20) unsigned zerofill NOT NULL COMMENT 'Reference to ub_message table message_id (Threading message)',
  ...
  KEY `job_id` (`job_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='All messages which is happend through internal system would get displayed here	' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `ub_message_details`
--

CREATE TABLE IF NOT EXISTS `ub_message_details` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `message_id` bigint(20) unsigned NOT NULL COMMENT 'Reference to ub_message table message_id',
  `user_id` bigint(20) unsigned NOT NULL COMMENT 'To whome the message is assigned to . Reference to ub_user table user_id',
  `placeholder_id` tinyint(3) unsigned NOT NULL,
  `is_read` enum('1','0') NOT NULL DEFAULT '0' COMMENT '1 is read and 0 is unread',
  `sent_type` enum('TO','CC','BCC') NOT NULL DEFAULT 'TO' COMMENT 'Email type, whether its TO / CC /BCC',
  `created_by` bigint(20) unsigned NOT NULL COMMENT ' Reference to ub_user table user_id',
  `created_on` datetime NOT NULL COMMENT 'Record created date and time',
  `modified_by` bigint(20) unsigned NOT NULL COMMENT ' Reference to ub_user table user_id',
  `modified_on` datetime NOT NULL COMMENT 'Last updated on time',
  ...
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='User details related to each message, message read/ unread status and the place holder informations' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `ub_message_place_holder`
--

CREATE TABLE IF NOT EXISTS `ub_message_place_holder` (
  `placeholder_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `placeholder_name_UNIQUE` (`placeholder_name`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Table will have the message place holder details like inbox, send items, trash etc.	' AUTO_INCREMENT=1 ;
...
--
-- Constraints for table `ub_message`
--
ALTER TABLE `ub_message`
  ADD CONSTRAINT `ub_message_ibfk_1` FOREIGN KEY (`job_id`) REFERENCES `ub_job` (`job_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `ub_message_details`
--
ALTER TABLE `ub_message_details`
  ADD CONSTRAINT `ub_message_details_ibfk_1` FOREIGN KEY (`message_id`) REFERENCES `ub_message` (`message_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `ub_message_details_ibfk_2` FOREIGN KEY (`placeholder_id`) REFERENCES `ub_message_place_holder` (`placeholder_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `ub_message_details_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `ub_user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
