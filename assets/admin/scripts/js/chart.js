...
function singup_trends(){ 
	var encoded_gantt_string = Base64.encode('admin/dashboard/get_signup_trend/') ;
	...
	$.ajax({
        ...
        var respon_data_silver = JSON.stringify(response.silver) ;
		var respon_data_gold = JSON.stringify(response.gold) ;
		var respon_data_platinum = JSON.stringify(response.platinum) ;
	    //console.log(JSON.stringify(response.silver));
		var charts = function () {
     //alert(respon_data);
    var data = [],
        totalPoints = 300,
	...
	var data_gold = respon_data_gold ;
	data = $.parseJSON(data_gold);
	var gold_plan = [];
	$.each(data, function (i,v)
	{
	  //console.log(i,v);
	...
	var data_platinum = respon_data_platinum ;
	data = $.parseJSON(data_platinum);
	var platinum_plan = [];
	$.each(data, function (i,v)
	{
	  //console.log(i,v);
