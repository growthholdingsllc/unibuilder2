 ...
 */
class UNI_Exceptions extends CI_Exceptions
{
	/**
	...
	public function __construct()
	{
		...
		set_exception_handler(array('UNI_Exceptions', 'exception_handler'));

		// Set the Error Handler
		set_error_handler(array('UNI_Exceptions', 'error_handler'));

		// Set the handler for shutdown to catch Parse errors
		register_shutdown_function(array('UNI_Exceptions', 'shutdown_handler'));
...
/* End of file: UNI_Exceptions.php */