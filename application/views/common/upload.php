<?php
//Below isset is for message module, when calling from message module.
isset($msg_data)?$folder_id=$msg_data['folder_id']:'';
isset($msg_data)?$temprory_dir_id=$msg_data['temprory_dir_id']:'';
// print_r($msg_data);
?>
