...
<div class="row m-top">
   ...
   <div class="btn btn-blue btn-file browse <?php if(isset($value['system_file_name'])){?>hide<?php } else{?>show<?php }?>" > <img border="0" class="uni_attchment_second" alt="" src="<?php echo IMAGESRC.'strip.gif'; ?>"> Browse
