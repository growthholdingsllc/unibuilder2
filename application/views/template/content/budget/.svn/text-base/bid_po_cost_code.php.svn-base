...
<div class="row m-top">
	...
	<div class="row">
	   ...
	   <div class="col-xs-2">                             
	     <input type="text" class="form-control varian" placeholder="Quantity" name="quantity[]" id="quantity" value="<?php if(isset($quantity[$i])) echo $quantity[$i] ?>" />
	   </div>    
	     <div class="col-xs-2">                             
	     <input type="text" class="form-control varian" placeholder="Unit Cost($)" name="unit_cost[]" id="unit_cost" value="<?php if(isset($unit_cost[$i])) echo $unit_cost[$i] ?>" />
	   </div>  
	   <div class="col-xs-2">                             
