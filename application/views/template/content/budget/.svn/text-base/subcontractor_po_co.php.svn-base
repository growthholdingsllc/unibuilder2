               ...
               <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="filter">
                  <div class="panel-body col-xs-12">
                     <div class="row five-col po">
                        ...
                        <div class="col-xs-3">
					   <label>PO_CO Status</label> 
					   <?php 
						   $status_selected = '';
						   if(isset($search_session_array['po_status']))
						   {
							$status_selected = explode(",",$search_session_array['po_status']);
						   }
							 echo form_dropdown('status_result', $status_result, $status_selected, "class='selectpicker form-control' id='po_status' data-live-search='true'"); 
                        ...
                        <div class="col-xs-3">
                           <label>PO_CO Payment Status</label>
                            <?php 
						   $payment_status_selected = '';
						   if(isset($search_session_array['payment_status']))
						   {
							$payment_status_selected = explode(",",$search_session_array['payment_status']);
						   }
                     ...
                     <div class="row five-col">
                        <div class="col-xs-6">
                           ...
                           <div>
                              ...
                              <button type="button" class="btn btn-gray">Save Filter</button>
                              <button type="button" class="btn btn-gray">Apply Saved Filter</button>
                           </div>
                        </div>
                     </div>
                  </div>
