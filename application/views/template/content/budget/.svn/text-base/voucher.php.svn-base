<table id="tab_customers" 
  class="tab_budget table" <?php if($payment_status['override']!='No'){?>style="width:900px;background-image: url(<?php echo IMAGESRC.'Voucherwithoverridde.png'; ?>);background-position:50% 50%; background-repeat: no-repeat;background-size: 500px 600px;"<?php } ?>>               			
        <tr>
			<td width="50%">
				<table width="100%">
					<tr>
					...
					<tr>
						<th colspan="2"  height="40"><?php if(isset($voucher_list['company']))echo $voucher_list['company'];?></th>
					</tr>
					<!--<tr>
						<td height="30">LAS VEGAS OFFICE</td><td>RENO OFFICE</td>
					</tr>-->
					<tr>
						<td height="30"><?php if(isset($voucher_list['address']))echo $voucher_list['address'];?></td><td>&nbsp;</td>
					</tr>
					<tr>
						<td height="30"><?php if(isset($voucher_list['city']))echo $voucher_list['city'].', '.$voucher_list['province'].' '.$voucher_list['postal'];?></td><td>&nbsp;</td>
					</tr>
					<tr>
			...
			<td width="50%">
				<table width="100%">
					...
					<tr>
						<th height="30">&nbsp;</th>
						<td class="under_line text-left"><?php if(isset($voucher_list['project_address']))echo $voucher_list['project_city'].', '.$voucher_list['project_province'].' '.$voucher_list['project_postal'];?></td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td colspan="2">Pay to the Order of <u><strong><?php if(isset($voucher_list['company']))echo $voucher_list['company'];?></strong></u></td>
		</tr>
		<tr>
			<td colspan="2"><u><?php if(isset($voucher_list['address']))echo $voucher_list['address'].', '.$voucher_list['city'].', '.$voucher_list['province'].' '.$voucher_list['postal'];?></u></td>
		</tr>
		<tr>
	   ...
	   <tr>
		<td>
			...
			<div class="pull-left">Patrick Ziade</div>
	   ...
	   <tr>
		<td>
			<p class="under_line"></p>
			<div class="pull-left">Progressive Construction dba Growth Const.</div>
			<div class="pull-right">(Date)</div>
		</td>
		<td>
