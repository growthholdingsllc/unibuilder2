...
<div class="row">
  <div class="col-xs-12">
    <div class="top-search pull-right">
        ...
        <a href="<?php echo base_url().$this->crypt->encrypt('template/task/save_task/'); ?>" class="btn btn-blue  pull-right">
...
<script type="text/javascript" src="<?php echo TEMPSRC.'task.js';?>"></script>