	   ...
	   <div class="col-xs-12">
		  <div class="top-search pull-right">
			 <div class="pull-right ">        
				<button type="submit" class="btn btn-default btn-primary pull-right m-left-1" id="add_task_new">Save &amp; New</button>
				<!--a href="<?php echo base_url();?>To-Do"-->
				<button type="submit" class="btn btn-default btn-primary pull-right m-left-1" id="add_task_back">Save &amp; Back</button></a>
			 </div>
		  </div>
	   </div>
	</div>
		  ...
		  <div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="row panel-content">
				   <div class="col-xs-6">
						<input type="text" class="form-control" placeholder="Tag" name="title" id="title">
