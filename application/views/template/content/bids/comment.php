         ...
         if($comments_list != false){?>
          ...
          <div class="<?php echo $class;?>" role="alert">
            <div class="row">
               ...
               <div class="col-xs-1">
                 <?php if($value['show_owner'] == 'Yes') { ?><p><a href="#"> <img src="<?php echo IMAGESRC.'owner.png'; ?>"></span></a></p><?php } ?>

                 <?php if($value['show_sub'] == 'Yes') { ?><p><a href="#"> <img src="<?php echo IMAGESRC.'sub.png'; ?>"></span></a></p><?php } ?>
