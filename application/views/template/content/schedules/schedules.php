      ...
      <div class="top-search pull-right">
         <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu" role="menu">
				...
				{ 
				?>
               <li><a href="<?php echo base_url().$this->crypt->encrypt('template/schedules/save_schedule/'); ?>">Schedule Item</a></li>
			   <?php 
			   }
			   ?>
            </ul>
...
<input type="hidden" id="current_tab" name="current_tab" value="listview" />
...
<script type="text/javascript" src="<?php echo TEMPSRC.'schedules.js';?>"></script>