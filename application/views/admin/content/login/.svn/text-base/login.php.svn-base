...
<body class="bg-primary uni_wrapper loadingDiv">
    ...
    <div class="row">
      <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
        <section class="panel bg-white no-b">
		  ...
		  <div class="col-xs-12 error-message uni_message mb20 ">
          ...
          <div class="row p15">
			...
			<div class="col-xs-12">
				<div class="form-group">
				  <input type="text" class="form-control mb10" name="username" id="username" placeholder="username"/>
				 </div>
			 </div>
			 <div class="col-xs-12">
				<div class="form-group">
              ...
              <div class="col-xs-12 show">
                <div class="pull-right mb10"> <a href="<?php echo base_url(); ?>YWRtaW4vbgxf19naW4vZm9yZ290">Forgot password?</a> </div>
              </div>
			   <div class="col-xs-12">
              <button type="submit" class="btn btn-primary btn-lg btn-block btn-parsley" id="login_submit">Sign in</button>
			  </div>
            </form>
          </div>
        </section>
