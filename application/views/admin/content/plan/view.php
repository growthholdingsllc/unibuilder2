...
<div class="wrapper">
  ...
  <!-- Top Button -->
  <div class="row mb20 text-right"> <a href="<?php echo base_url().$this->crypt->encrypt('admin/plans/addplan/'); ?>">
    <button class="btn btn-primary" type="button">New Plan</button>
    </a> </div>
  <!-- /Top Button --> 
  ...
  <div class="row">
    <section class="main-content">
      <div class="content-wrap">
        <section class="panel">
          <table class="table table-bordered table-striped mg-t datatable" id="plan_list">
            <thead>
              <tr>
...
<script src="<?php echo ACJI.'scripts/js/paln-view-datatables.js';?>"></script> 
<!-- /page script --> 
