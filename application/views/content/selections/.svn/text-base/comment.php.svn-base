         ...
         if($comments_list != false){?>
          ...
          <div class="<?php echo $class;?>" role="alert">
            <div class="row">
               ...
               <div class="col-xs-1">
                 <?php if($value['show_owner'] == 'Yes') { ?><p><img class="uni_owner" src="<?php echo IMAGESRC.'strip.gif'; ?>" title="Owner" /></p><?php } ?>
                 <?php if($value['show_sub'] == 'Yes') { ?><p><img class="uni_sub" src="<?php echo IMAGESRC.'strip.gif'; ?>" title="Subcontractor"></p><?php } ?>
