  ...
  <div class="col-xs-12">
    <div class="top-search pull-right">
		...
		if(isset($this->user_role_access[strtolower('selections')][strtolower('add')]) && $this->user_role_access[strtolower('selections')][strtolower('add')] == 1)
		{
			...
			{
		?>
      <div class="pull-right "> <a href="<?php echo base_url().$this->crypt->encrypt('selections/save_selection/'); ?>">
      ...
      <div class="panel-group" id="accordion1" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default">
          ...
          <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="filter">
            <div class="panel-body col-xs-12 primary_filt">
              <div class="row five-col">
                ...
                <div class="col-xs-3">
				  ...
				  $subcontractor_selected = '';
				   if(isset($search_session_array['vendors']))
				   {
						$subcontractor_selected = $search_session_array['vendors'];
				   }
				   echo form_dropdown('vendors',$subcontractor_list, $subcontractor_selected, "class='selectpicker form-control' id='vendors' data-live-search='true'"); 
				 ?>
                </div>
                <div class="col-xs-3">
                  <label>Title</label>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Import Selections From Template </h4>
      </div>
      <div class="modal-body">
        ...
        <label>New Deadline Date <small>(Blank for none)</small></label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Import Selections</button>
      </div>
    </div>
  </div>
</div>
...
<input type="hidden" id="current_tab" name="current_tab" value="List" />
...
<script type="text/javascript" src="<?php echo JSSRC.'selections.js';?>"></script> 