						  ...
						  if(isset($get_sub_contractor_array_list_details) && count($get_sub_contractor_array_list_details)>0)
							{
								...
								{ ?>
								   <li value="<?php echo $get_sub_contractor_array_list_details[$i]['user_id'];?>"><?php echo $get_sub_contractor_array_list_details[$i]['fullname'];?></li>
								<?php 
								} 
							}  
						  ...
						  if(isset($get_sub_contractor_selected_details) && count($get_sub_contractor_selected_details)>0)
							{
								...
								{ 
									$view_access_userids = $view_access_userids.$get_sub_contractor_selected_details[$i]['user_id'].',';
								?>
								   <li value="<?php echo $get_sub_contractor_selected_details[$i]['user_id'];?>"><?php echo $get_sub_contractor_selected_details[$i]['fullname'];?></li>
								<?php 
								} 
							}  
