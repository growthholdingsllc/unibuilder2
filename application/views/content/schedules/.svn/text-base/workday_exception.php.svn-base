...
<div class="row">
   <div class="col-xs-12">
      <div class="top-search pull-right">
		...
		<?php if(isset($result_data['ub_workday_exception_id']) && !empty($result_data['ub_workday_exception_id']))
		{ ?>
		<button class="btn btn-blue  pull-right m-left-1" type="button" id="<?php if(isset($result_data['ub_workday_exception_id'])) echo $result_data['ub_workday_exception_id']; ?>" name="delete_workday" onclick="delete_workdays(this.id)"><img src="<?php echo IMAGESRC.'strip.gif'; ?>" class="uni_delete"/>Delete</button>
			<?php } ?>
        </a> <a href="#" >
          ...
          <div class="col-xs-12">
            <div class="modal-con">              
              <div class="row col-xs-12">                				
				<button class="btn btn-gray m-left-1 pull-right" type="button" data-dismiss="modal"><img src="<?php echo IMAGESRC.'strip.gif'; ?>" class="cancel_icon" id="delete_cancel"/> CANCEL</button>  
