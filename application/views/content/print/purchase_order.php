...
<html>
   ...
   <body>
      <table border="0" align="center" cellpadding="0" cellspacing="0" style="width:800px; margin:10px auto; font-family:Arial, Helvetica, sans-serif; font-size:16px;color:#535353">
		...
		<tr>
			<td height="40"><p style="font-size:18px" align="left"><?php echo $builder_details['builder_address'].' '; ?></p> </td>
			<td><p style="font-size:18px" align="left"><img src="<?php echo IMAGESRC.'print_image/phone.png'; ?>"> Phone : <?php echo $builder_details['builder_phone']; ?> </p></td>
		</tr>
		<tr>
			<td colspan="2"><hr/></td>			
		</tr>
         ...
         <tr>
            <td colspan="2" style=" padding: 7px 0px 13px;" align="right" >
               <h2 style="color:#343434">PURCHASE ORDER</h2>
               <table border="0"  cellpadding="0" cellspacing="0" style="border:2px solid #8D8D8D; border-collapse: collapse; font-size:20px; font-family:Arial, Helvetica, sans-serif; width:265px;color:#535353">
                  <tr>
                     ...
                     <td style="border:2px solid #8D8D8D; border-collapse: collapse;  padding:5px">
                        <p><?php if(isset($builder_details['po_release_date']['modified_on'])) echo $builder_details['po_release_date']['modified_on']; ?></p>
                     </td>
                  </tr>
                  <tr>
                     <td style="border:2px solid #8D8D8D; border-collapse: collapse;  padding:5px">
                     ...
                     <td style="border:2px solid #8D8D8D; border-collapse: collapse;  padding:5px">
                        <p><?php echo $builder_details['po_data']['ub_po_co_number']; ?></p>
                     </td>
                  </tr>
               </table>
            </td>
                  ...
                  <tr>
                     ...
                     <td>
                        <table border="0"  cellpadding="0" cellspacing="0" WIDTH="300" style="font-family:Arial, Helvetica, sans-serif; font-size:16px;color:#626262;">
                           ...
                           <tr>
                              <td STYLE="padding:6px;font-size:18px">
                                 <p><?php echo $builder_details['project_address']['project_name']; ?></br><?php echo $builder_details['project_address']['address'];?></br><?php echo $builder_details['project_address']['city'].$builder_details['project_address']['province']; ?></br><?php echo $builder_details['project_address']['country'].' '.$builder_details['project_address']['postal']; ?></p>
                              </td>
                           </tr>
                        </table>
                     </td>
               ...
               <table border="0"  cellpadding="0" cellspacing="0" width="800" style="color:#636363;border:2px solid #7B7B7B; border-collapse: collapse; font-size:18px;">
                  ...
                  <tr>
                     <td style="border:2px solid #7B7B7B; border-collapse: collapse;  padding:10px" align="center">
                        <p><?php echo $builder_details['po_data']['title']; ?></p>
                     </td>
                     <td style="border:2px solid #7B7B7B; border-collapse: collapse;  padding:10px" align="center">
                        <p><?php echo $builder_details['po_data']['due_date']; ?></p>
                     </td>
                     <td style="border:2px solid #7B7B7B; border-collapse: collapse;  padding:10px" align="center">
                        <p><?php echo $builder_details['po_data']['po_status']; ?></p>
                     </td>
                     <td style="border:2px solid #7B7B7B; border-collapse: collapse;  padding:10px" align="center">
                        <p><?php echo '$ '.$builder_details['po_data']['total_amount']; ?></p>
                     </td>
                  </tr>
               </table>
            </td>
         ...
         <tr>
            <td colspan="2" style="padding:40px 0px;">
               <p>A signature or electronic Acceptance is required for purchase order to be effective.</p>
            </td>
         </tr>
         <tr >
            <td colspan="2">
