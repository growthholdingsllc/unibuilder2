<div class="col-xs-12">
	...
	if(isset($this->user_role_access[strtolower('budget')][strtolower('add')]) && $this->user_role_access[strtolower('budget')][strtolower('add')] == 1)
	{
		...
		{
	?>
		<a href="<?php echo base_url().$this->crypt->encrypt('budget/add_multiple_items'); ?>">
			<button type="button" class="sprite pull-right"> 
			<img border="0" src="<?php echo IMAGESRC.'strip.gif'; ?>" alt="New" class="plus"> Add Multiple Estimate Items</button>
		</a>
...
<input type="hidden" name="ub_estimate_id" id="ub_estimate_id" value="<?php echo isset($result_data['ub_estimate_id'])?$result_data['ub_estimate_id']:0 ?>" />
...
<div class="col-xs-12">
		...
		<div class="col-xs-12">
			<div class="form-group">
				...
				<?php
				   ...
				   <a class="TypeAddModal"  href="javascript:void(0);">
	...
	<div class="row m-top">
		...
		<!--<div class="col-xs-3">				
			<input type="text" class="form-control" placeholder="client contract($)" id="client_contract" name="client_contract" value="<?php //echo isset($result_data['client_contract'])?$result_data['client_contract']:'' ?>"/>
		</div>-->
		<div class="col-xs-6">
			<label>&nbsp;</label>
			<div>
		   ...
		   if(isset($result_data['ub_estimate_id']) && $result_data['ub_estimate_id'] > 0)
		   { 
				if(isset($this->project_status_check) && $this->project_status_check == 1)
				{
		   ?>
