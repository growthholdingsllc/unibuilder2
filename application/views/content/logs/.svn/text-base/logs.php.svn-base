   ...
   <div class="col-xs-12">
      <div class="top-search pull-right">
        <div class="pull-right ">
			<?php
			if(isset($this->user_role_access[strtolower('logs')][strtolower('add')]) && $this->user_role_access[strtolower('logs')][strtolower('add')] == 1)
			{
				if(isset($this->project_status_check) && $this->project_status_check == 1)
				{
			?>
			<a href="<?php echo base_url(); ?>bgxf19ncy9zYXZlX2xvZy8-">
			<button class="btn btn-blue pull-right" type="button">
				<img border="0" class="uni_new" alt="" src="<?php echo IMAGESRC.'strip.gif'; ?>"> New Log
			</button>				
			</a>
			<?php 
				}
            ...
            <div class="panel panel-default">
               ...
               <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="filter">
                  <form id="Search_Result" name="Search_Result" method="post" class="form-horizontal">
                           ...
                           <div class="col-xs-3">
                              <label>Tags</label>							  
                               <?php 
                                 ...
                                 echo form_dropdown('tags[]', $log_tags_array, $tag_selected, "class='selectpicker form-control' id='tags' data-live-search='true' multiple"); 
                                ?>                           
                           </div>
                      <!--      <div class="col-xs-3">
                              <label>Have a project</label>
							  <div class="col-xs-12">							  
								  <div class="form-group">
											  <?php 
											   ...
											   {
													$project_selected = explode(",",$search_session_array['project']);
											   }
                        ...
                        <div class="row text-center">
                           ...
                           <button type="submit" class="btn btn-gray" id="log_search_reset" >Reset</button>
                     ...
                     <?php } else{ ?>
						<button type="button" class="btn btn-gray" id="apply_save_filter" name="apply_save_filter" style="display:none;" >Apply Saved Filter</button>
                     <?php } ?>
...
<div class="row">
   ...
   <div class="add-function">
      ...
      <div class="col-xs-3 pull-left">
         <select class="selectpicker form-control" onchange="delete_all_checked_logs(this.value)" title="Task Actions">
            <option value="">Bulk Actions</option>
            <option value="delete_multi_logs">Delete Checked LOGS</option>
         </select>         
      </div>
	  <?php 
	  }
      ...
      <div class="col-xs-3 pull-right">
		<?php 
		if(isset($this->user_role_access[strtolower('logs')][strtolower('export excel')]) && $this->user_role_access[strtolower('logs')][strtolower('export excel')] == 1)
		{
		?>
		...
		?>
	  <!--<a data-target="#LogslistModal" data-toggle="modal" href="javascript:void(0);">
...
<div class="row roles m-top">
   <div class="col-xs-12 pull-left">
      <table class="table table-bordered datatable" id="Logs_List" width="100%">
         <thead>
            <tr>
...
<!-- /Logs List Modal -->
<div class="modal fade" id="LogslistModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<input type="hidden" id="logs_index" value="" />
...
<script type="text/javascript" src="<?php echo JSSRC.'logs.js';?>"></script>