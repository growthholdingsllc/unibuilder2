...
class Authorize_arb
{
	...
	private $type_list = array(	// The type of action we want to perform
		...
		'get_settlement' => 'getSettledBatchListRequest',
		'batch_statistics' => 'getBatchStatisticsRequest',
		'get_transaction' => 'getTransactionListRequest',
	...
	{
		$xml_data = $this->xml_to_array($this->response);
		return $xml_data;
	}
	...
	{
		$send_data = $this->xml_to_array($this->send_data);
		return $send_data;
	}
	...
	{
		$error_data = $this->xml_to_array($this->error);
		return $error_data;
	}
