...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__).'/html2pdf_download/_class/exception.class.php');
    require_once(dirname(__FILE__).'/html2pdf_download/_class/locale.class.php');
    require_once(dirname(__FILE__).'/html2pdf_download/_class/myPdf.class.php');
    require_once(dirname(__FILE__).'/html2pdf_download/_class/parsingHtml.class.php');
    require_once(dirname(__FILE__).'/html2pdf_download/_class/parsingCss.class.php');
