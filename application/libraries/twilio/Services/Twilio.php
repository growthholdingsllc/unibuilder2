...
function Services_Twilio_autoload($className)
{
    ...
    return require_once dirname(__FILE__) . "/$file.php";
}
...
abstract class Base_Services_Twilio extends Services_Twilio_Resource
{
    ...
    private function _processResponse($response)
    {
		...
		{
			$array_format = json_decode($response[2],true);
			if(isset($array_format['code']) && (21614 == $array_format['code'] || 21211 == $array_format['code']))
			{
